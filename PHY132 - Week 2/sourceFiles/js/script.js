...
function updateCompletion(key,grade=100){

progress.setKey(key, {status:"done", grade:grade}).then(function(){for (var i = 0; i < state.chapters.length; i++) {
